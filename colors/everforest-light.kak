...
try %{
    ...
    provide-module powerline_everforest_light %§
        ...
        define-command -hidden powerline-theme-everforest-light %{ evaluate-commands %sh{
    	printf "%s\n" "
                ...
                declare-option -hidden str powerline_next_bg rgb:e6e6e6
                declare-option -hidden str powerline_base_bg rgb:e6e6e6
            "
        }}
    §
}
