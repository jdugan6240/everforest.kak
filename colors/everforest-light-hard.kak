...
# powerline.kak
try %{
    hook global ModuleLoaded powerline %{ require-module powerline_everforest_light_hard }
    provide-module powerline_everforest_light_hard %§
        set-option -add global powerline_themes "everforest-light-hard"
        define-command -hidden powerline-theme-everforest-light-hard %{
