...
# powerline.kak
try %{
    hook global ModuleLoaded powerline %{ require-module powerline_everforest_light_soft }
    provide-module powerline_everforest_light_soft %§
        set-option -add global powerline_themes "everforest-light-soft"
        define-command -hidden powerline-theme-everforest-light-soft %{
